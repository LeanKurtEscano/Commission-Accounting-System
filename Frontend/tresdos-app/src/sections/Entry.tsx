      ...
      <div className="max-w-4xl pt-2 mx-auto">
        ...
        <form className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label htmlFor="start-date" className="block text-sm mb-2 font-medium text-slate-100">
                Start Date
              </label>
              <input
                type="date"
            ...
            <div>
              <label htmlFor="end-date" className="block text-sm font-medium mb-2 text-slate-100">
                End Date
              </label>
              <input
                type="date"
